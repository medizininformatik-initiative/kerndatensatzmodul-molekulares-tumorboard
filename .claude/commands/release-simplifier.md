...
2. Navigate to: https://simplifier.net/mii-erweiterungsmodul-molekulares-tumorboard
...
1. Verify package appears at: https://packages.simplifier.net/de.medizininformatikinitiative.kerndatensatz.mtb
...
```
For this project: `fhir project link mii-erweiterungsmodul-molekulares-tumorboard --strategy TakeLocal`
...
```
# MII Molekulares Tumorboard 2026.0.0

[Full Release Notes](https://simplifier.net/guide/MII-IG-MTB-DE/MIIIGModulMolekularesTumorboard/Release-Notes)
...
```
Example: `fhir publish-package de.medizininformatikinitiative.kerndatensatz.mtb.2026.0.0.tgz`
