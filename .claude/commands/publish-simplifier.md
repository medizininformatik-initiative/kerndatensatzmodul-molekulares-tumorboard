...
```bash
# Navigate to project
cd /Users/thome/code/fhir-profiling/kerndatensatzmodul-molekulares-tumorboard

# Publish package
simplifier push \
  --project mii-erweiterungsmodul-molekulares-tumorboard \
  --version [VERSION] \
...
1. Navigate to https://simplifier.net/mii-erweiterungsmodul-molekulares-tumorboard
...
3. Test package installation:
   ```bash
   fhir install de.medizininformatikinitiative.kerndatensatz.mtb@[VERSION]
   ```
...
**URL**: https://simplifier.net/mii-erweiterungsmodul-molekulares-tumorboard/~packages
**Install Command**:
  fhir install de.medizininformatikinitiative.kerndatensatz.mtb@[VERSION]
```
