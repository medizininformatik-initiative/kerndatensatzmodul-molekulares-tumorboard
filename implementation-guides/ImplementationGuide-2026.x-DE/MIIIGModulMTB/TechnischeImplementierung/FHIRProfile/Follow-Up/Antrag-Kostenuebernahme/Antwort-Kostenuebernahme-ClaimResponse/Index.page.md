...
for
    differential.element
    where
        id.contains('AntwortKostenuebernahme') and mapping.first().map.contains('ClaimResponse')
    select 
        Datensatz: short,
...
<tabs>
    <tab title="Tabelle">{{table: ClaimResponse/MII-EXA-MTB-Antwort-Kostenuebernahme-Beispiel-1}}</tab>
    <tab title="JSON">{{json: ClaimResponse/MII-EXA-MTB-Antwort-Kostenuebernahme-Beispiel-1}}</tab>
</tabs>
