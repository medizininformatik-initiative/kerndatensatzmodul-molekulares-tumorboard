...
parent:
topic: RNA Fusion
subject: https://www.medizininformatik-initiative.de/fhir/ext/modul-mtb/StructureDefinition/mii-pr-mtb-rna-fusion
---
...
where url = 'https://www.medizininformatik-initiative.de/fhir/ext/modul-mtb/StructureDefinition/LogicalModel/mii-lm-mtb'
    ...
    where
        id.contains('RNAFusion') and 
        mapping.first().map.contains('MII_PR_MTB_RNA_Fusion')
    select 
        Datensatz: short,
