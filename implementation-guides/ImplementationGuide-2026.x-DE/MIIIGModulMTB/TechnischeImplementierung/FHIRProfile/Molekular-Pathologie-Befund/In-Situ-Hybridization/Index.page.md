...
| Profil | Beschreibung |
|--------|--------------|
| **MII_PR_MTB_Biomarker_InSituHybridization** | Generisches ISH-Profil für alle ISH-Methoden |
| **MII_PR_MTB_INSITUHYBRIDIZATION_HER2** | Spezialisiertes Profil für HER2/ERBB2 FISH |
...
* **MII_VS_MTB_ISH_Method** - ISH-Methodentypen (FISH, CISH, SISH)
