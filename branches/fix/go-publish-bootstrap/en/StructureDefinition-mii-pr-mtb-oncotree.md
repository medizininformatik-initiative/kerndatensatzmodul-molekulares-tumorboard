# MII PR MTB Oncotree Klassifikation - MII IG Kerndatensatz-Modul Molekulares Tumorboard v2027.0.0-ballot.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MII PR MTB Oncotree Klassifikation**

## Resource Profile: MII PR MTB Oncotree Klassifikation 

| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-mtb/StructureDefinition/mii-pr-mtb-oncotree | *Version*:2027.0.0-ballot.1 |
| Active as of 2026-09-15 | *Computable Name*:MII_PR_MTB_Oncotree |
...
1. The search parameter "_profile" MUST be supported:Examples:`GET [base]/Observation?_profile=https://www.medizininformatik-initiative.de/fhir/ext/modul-mtb/StructureDefinition/mii-pr-mtb-oncotree`Usage notes: Further information on searching for "_profile" can be found in the [FHIR base specification - section "Token Search"](https://hl7.org/fhir/R4/search.html#token).
1. The search parameter "code" MUST be supported:Examples:`GET [base]/Observation?code=http://snomed.info/sct|371469007`Usage notes: Further information on searching for "code" can be found in the [FHIR base specification - section "Token Search"](https://hl7.org/fhir/R4/search.html#token).
...
1. The search parameter "combo-value-concept" MUST be supported:Examples:`GET [base]/Observation?combo-value-concept=http://data.mskcc.org/ontologies/oncotree|HGONEC`Usage notes: Further information on searching for "combo-value-concept" can be found in the [FHIR base specification - section "Token Search"](https://hl7.org/fhir/R4/search.html#token).
...
Other representations of profile: [CSV](../StructureDefinition-mii-pr-mtb-oncotree.csv), [Excel](../StructureDefinition-mii-pr-mtb-oncotree.xlsx), [Schematron](../StructureDefinition-mii-pr-mtb-oncotree.sch) 
