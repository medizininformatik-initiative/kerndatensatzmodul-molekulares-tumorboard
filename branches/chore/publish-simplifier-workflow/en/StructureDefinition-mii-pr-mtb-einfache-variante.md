# MII PR MTB Einfache Variante - MII IG Kerndatensatz-Modul Molekulares Tumorboard v2027.0.0-ballot.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MII PR MTB Einfache Variante**

## Resource Profile: MII PR MTB Einfache Variante 

| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-mtb/StructureDefinition/mii-pr-mtb-einfache-variante | *Version*:2027.0.0-ballot.1 |
| Active as of 2026-09-15 | *Computable Name*:MII_PR_MTB_Einfache_Variante |
...
This profile enables the description of a simple variant.
...
Other representations of profile: [CSV](../StructureDefinition-mii-pr-mtb-einfache-variante.csv), [Excel](../StructureDefinition-mii-pr-mtb-einfache-variante.xlsx), [Schematron](../StructureDefinition-mii-pr-mtb-einfache-variante.sch) 
