# MTB-Behandlungsepisode Kim Musterperson - MII IG Kerndatensatz-Modul Molekulares Tumorboard v2027.0.0-ballot.1

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MTB-Behandlungsepisode Kim Musterperson**

## Beispiel ClinicalImpression: MTB-Behandlungsepisode Kim Musterperson
...
Profile: [MII PR MTB Behandlungsepisode](StructureDefinition-mii-pr-mtb-behandlungsepisode.md) version: 2027.0.0-ballot.1

**status**: Completed

**subject**: [Kim Musterperson (no stated gender), DoB: 1956-03-14](Patient-PatientKimMusterperson.md)

**effective**: 2023-01-20 --> 2023-03-28

**problem**: [Condition Bösartige Neubildung: Peritoneum, nicht näher bezeichnet](Condition-mii-exa-mtb-kim-diagnose.md)

> **investigation****code**: Genetic finding**item**: [Diagnostic Report for 'Genetic analysis report' for '->Kim Musterperson (no stated gender), DoB: 1956-03-14'](DiagnosticReport-mii-exa-mtb-kim-musterperson-ngs-bericht.md)

> **investigation****code**: Pathology synoptic report**item**: [Diagnostic Report for 'Pathology synoptic report' for '->Kim Musterperson (no stated gender), DoB: 1956-03-14'](DiagnosticReport-PatientKimMusterperson-MolecularPathologyReport-1.md)

> **investigation****code**: ECOG performance status finding**item**: [Observation ECOG performance status](Observation-mii-exa-onko-allgemeiner-leistungszustand-ecog.md)
...
* [Procedure Computertomographie [CT], nativ](Procedure-PatientKimMusterperson-Procedure-1.md)
* [Observation Metastatic malignant neoplasm (disorder)](Observation-PatientKimMusterperson-Observation-1.md)
* [Observation Recurrent](Observation-PatientKimMusterperson-Observation-2.md)
* [Observation Ascites](Observation-PatientKimMusterperson-Observation-3.md)
* [Observation Status post (contextual qualifier) (qualifier value)](Observation-PatientKimMusterperson-Observation-4.md)
* [Procedure Computertomographie [CT], nativ](Procedure-PatientKimMusterperson-Procedure-2.md)
* [Observation Status post (contextual qualifier) (qualifier value)](Observation-PatientKimMusterperson-Observation-5.md)
* [Observation Ascites](Observation-PatientKimMusterperson-Observation-6.md)
* [Observation Recurrent](Observation-PatientKimMusterperson-Observation-7.md)
* [Observation Atypical](Observation-PatientKimMusterperson-Observation-8.md)
* [Procedure Computertomographie [CT], nativ](Procedure-PatientKimMusterperson-Procedure-3.md)
* [Observation Status post (contextual qualifier) (qualifier value)](Observation-PatientKimMusterperson-Observation-9.md)
* [Observation Status post (contextual qualifier) (qualifier value)](Observation-PatientKimMusterperson-Observation-10.md)
* [Observation Ascites](Observation-PatientKimMusterperson-Observation-11.md)
* [Observation Recurrent](Observation-PatientKimMusterperson-Observation-12.md)
* [Observation Recurrent](Observation-PatientKimMusterperson-Observation-13.md)
...
* [Observation True pelvis](Observation-PatientKimMusterperson-Observation-21.md)
* [Observation Localized enlarged lymph nodes](Observation-PatientKimMusterperson-Observation-22.md)
* [Observation Lesion](Observation-PatientKimMusterperson-Observation-23.md)
* [Procedure Chemotherapy](Procedure-MTBChemo2Procedure.md)
* [Procedure Computertomographie [CT], nativ](Procedure-PatientKimMusterperson-Procedure-6.md)
* [Observation Ascites](Observation-PatientKimMusterperson-Observation-24.md)
* [Observation Recurrent](Observation-PatientKimMusterperson-Observation-25.md)
