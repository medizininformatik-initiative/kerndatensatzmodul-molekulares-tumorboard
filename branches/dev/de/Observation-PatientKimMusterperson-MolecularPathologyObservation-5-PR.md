# PatientKimMusterperson-MolecularPathologyObservation-5-PR - MII IG Kerndatensatz-Modul Molekulares Tumorboard v2027.0.0-ballot.1

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **PatientKimMusterperson-MolecularPathologyObservation-5-PR**

## Beispiel Observation: PatientKimMusterperson-MolecularPathologyObservation-5-PR
...
**code**: Cells.progesterone receptor/cells in Tissue by Immune stain

**subject**: [Kim Musterperson (no stated gender), DoB: 1956-03-14](Patient-PatientKimMusterperson.md)

**value**: 30 % (Details: UCUM code/100 = '/100')
