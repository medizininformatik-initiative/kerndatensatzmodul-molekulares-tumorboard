# MII PR MTB Copy Number Variant - MII IG Kerndatensatz-Modul Molekulares Tumorboard v2027.0.0-ballot.1

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII PR MTB Copy Number Variant**

## Ressourcenprofil: MII PR MTB Copy Number Variant 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-mtb/StructureDefinition/mii-pr-mtb-copy-number-variant | *Version*:2027.0.0-ballot.1 |
| Active Stand: 2026-09-15 | *Maschinenlesbarer Name*:MII_PR_MTB_Copy_Number_Variant |
...
Dieses Profil beschreibt die Copy Number Variante. Eine CNV kann nur ein einzelnen Genabschnitt, ein Gen oder einen Chromosomabschnitt mit mehreren Genen umfassen. Um dieser Tatsache gerecht zu werten, wurden ergänzend zum HL7 Clinical Genomics Reporting Implementation Guide folgende Datenpunkte durch dnpm erarbeitet:

* Gesamtzahl der CNVs
* Anzahl der einzelnen Allele A und B
* Relative Copy Number
* Focality
* betroffene Gene
* copy-number-neutrales Loss-of-Heterozygocity
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-pr-mtb-copy-number-variant.csv), [Excel](../StructureDefinition-mii-pr-mtb-copy-number-variant.xlsx), [Schematron](../StructureDefinition-mii-pr-mtb-copy-number-variant.sch) 
