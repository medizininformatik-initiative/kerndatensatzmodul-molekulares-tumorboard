...
**focus**: [MII_PR_MTB_Diagnose_Primaertumor/example](https://simplifier.net/resolve?scope=de.basisprofil.r4@1.5.4&canonical=http://fhir.org/packages/de.basisprofil.r4/MII_PR_MTB_Diagnose_Primaertumor/example)
