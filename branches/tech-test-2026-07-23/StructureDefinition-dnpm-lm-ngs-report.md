...
## Logical Model: DNPM NGS Report 

| | |
| :--- | :--- |
| *Official URL*:https://dnpm-dip.net/fhir/StructureDefinition/dnpm-lm-ngs-report | *Version*:2026.0.1 |
| Active as of 2026-07-23 | *Computable Name*:DNPM_LM_NGSReport |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/mii-kerndatensatzmodul-molekulares-tumorboard|current/StructureDefinition/StructureDefinition-dnpm-lm-ngs-report.json)
...
Other representations of profile: [CSV](StructureDefinition-dnpm-lm-ngs-report.csv), [Excel](StructureDefinition-dnpm-lm-ngs-report.xlsx) 
