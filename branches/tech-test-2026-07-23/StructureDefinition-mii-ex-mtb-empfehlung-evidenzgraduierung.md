...
| Active as of 2026-07-23 | *Computable Name*:MII_EX_MTB_Empfehlung_Evidenzgraduierung |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/mii-kerndatensatzmodul-molekulares-tumorboard|current/StructureDefinition/StructureDefinition-mii-ex-mtb-empfehlung-evidenzgraduierung.json)
