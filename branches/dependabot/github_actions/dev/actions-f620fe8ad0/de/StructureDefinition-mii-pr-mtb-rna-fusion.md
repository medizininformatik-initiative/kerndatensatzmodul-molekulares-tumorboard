# MII PR MTB RNA Fusion - MII IG Kerndatensatz-Modul Molekulares Tumorboard v2026.0.1

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII PR MTB RNA Fusion**

## Ressourcenprofil: MII PR MTB RNA Fusion 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-mtb/StructureDefinition/mii-pr-mtb-rna-fusion | *Version*:2026.0.1 |
| Active Stand: 2026-09-14 | *Maschinenlesbarer Name*:MII_PR_MTB_RNA_Fusion |
...
Dieses Profil beschreibt die RNA-Fusion im NGS-Bericht. Die korrekte, präzise und standardisierte Darstellung von Fusions-Varianten ist bislang über den Clinical Genomics Reporting Implementation Guide nicht möglich. International arbeitet die GA4GH an einer präzisen, menschen- und maschinenlesbaren Repräsentation (Variation Representation Specification, VRS), die sich als Standard beim Austausch zwischen den öffentlich zugänglichen Datenbanken (ClinVar, OnkoKB, VICC) etabliert.
...
Der 5' Fusion Partner wird dargestellt durch mehrere Elemente im component Slice: 
 MII_PR_MTB_RNA_Fusion.component[five-prime-gene], MII_PR_MTB_RNA_Fusion.component[five-prime-transcript-id], MII_PR_MTB_RNA_Fusion.component[five-prime-exon-id], MII_PR_MTB_RNA_Fusion.component[five-prime-position] und MII_PR_MTB_RNA_Fusion.component[five-prime-strand]. Der 3' Fusion Partner analog dazu mit MII_PR_MTB_RNA_Fusion.component[three-prime-…].
...
* Examples for this Profile: [Observation/MII-EXA-MTB-RNA-Fusion-1](Observation-MII-EXA-MTB-RNA-Fusion-1.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.medizininformatikinitiative.kerndatensatz.mtb|current/StructureDefinition/StructureDefinition-mii-pr-mtb-rna-fusion.json)
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-pr-mtb-rna-fusion.csv), [Excel](../StructureDefinition-mii-pr-mtb-rna-fusion.xlsx), [Schematron](../StructureDefinition-mii-pr-mtb-rna-fusion.sch) 
...
```json
{
  ...
  "url" : "https://www.medizininformatik-initiative.de/fhir/ext/modul-mtb/StructureDefinition/mii-pr-mtb-rna-fusion",
  "version" : "2026.0.1",
  "name" : "MII_PR_MTB_RNA_Fusion",
  "title" : "MII PR MTB RNA Fusion",
  "status" : "active",
  "date" : "2026-09-14T18:22:51+00:00",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "short" : "VariantenId innerhalb des NGS-Befundes",
      "_short" : {
        "extension" : [{
          "extension" : [{
            "url" : "lang",
          ...
          {
            "url" : "content",
            "valueString" : "VariantenId innerhalb des NGS-Befundes"
          }],
        ...
        },
        {
          ...
          {
            "url" : "content",
            "valueString" : "Variant ID within the NGS report"
          }],
          "url" : "http://hl7.org/fhir/StructureDefinition/translation"
        }]
      },
    ...
    },
    {
      ...
      "short" : "Variant database ID (e.g. COSMIC)",
      "_short" : {
        "extension" : [{
          "extension" : [{
            "url" : "lang",
          ...
          {
            "url" : "content",
            "valueString" : "Varianten-Datenbank-ID (z.B. COSMIC)"
          }],
          "url" : "http://hl7.org/fhir/StructureDefinition/translation"
        },
        {
          ...
          {
            "url" : "content",
            "valueString" : "Variant database ID (e.g. COSMIC)"
          }],
          "url" : "http://hl7.org/fhir/StructureDefinition/translation"
        }]
      }
    ...
    {
      "id" : "Observation.component:five-prime-gene.value[x]",
      "path" : "Observation.component.value[x]",
      "slicing" : {
        "discriminator" : [{
          "type" : "type",
    ...
    {
      "id" : "Observation.component:five-prime-gene.value[x]:valueCodeableConcept",
      "path" : "Observation.component.value[x]",
    ...
    {
      "id" : "Observation.component:five-prime-transcript-id",
      "path" : "Observation.component",
      "sliceName" : "five-prime-transcript-id",
      "short" : "5' Transcript - Identifier",
      "_short" : {
        "extension" : [{
          "extension" : [{
            "url" : "lang",
          ...
          {
            "url" : "content",
            "valueString" : "5' Transkript - Identifier"
          }],
          "url" : "http://hl7.org/fhir/StructureDefinition/translation"
        },
        {
          ...
          {
            "url" : "content",
            "valueString" : "5' Transcript - Identifier"
          }],
          "url" : "http://hl7.org/fhir/StructureDefinition/translation"
        }]
      },
    ...
    {
      "id" : "Observation.component:five-prime-transcript-id.code",
      "path" : "Observation.component.code",
      "patternCodeableConcept" : {
        "coding" : [{
          "system" : "https://www.medizininformatik-initiative.de/fhir/ext/modul-mtb/CodeSystem/mii-cs-mtb-molekulare-biomarker",
    ...
    {
      "id" : "Observation.component:five-prime-transcript-id.value[x]",
      "path" : "Observation.component.value[x]",
      "slicing" : {
        "discriminator" : [{
          "type" : "type",
    ...
    {
      "id" : "Observation.component:five-prime-transcript-id.value[x]:valueCodeableConcept",
      "path" : "Observation.component.value[x]",
      "sliceName" : "valueCodeableConcept",
      "min" : 0,
      "max" : "1",
    ...
    {
      "id" : "Observation.component:five-prime-exon-id",
      "path" : "Observation.component",
      "sliceName" : "five-prime-exon-id",
      "short" : "5' Exon - Identifier",
      "_short" : {
        "extension" : [{
          "extension" : [{
            "url" : "lang",
    ...
    {
      "id" : "Observation.component:five-prime-exon-id.code",
      "path" : "Observation.component.code",
      "patternCodeableConcept" : {
        "coding" : [{
          "system" : "https://www.medizininformatik-initiative.de/fhir/ext/modul-mtb/CodeSystem/mii-cs-mtb-molekulare-biomarker",
    ...
    {
      "id" : "Observation.component:five-prime-exon-id.value[x]",
      "path" : "Observation.component.value[x]",
      "slicing" : {
        "discriminator" : [{
          "type" : "type",
    ...
    {
      "id" : "Observation.component:five-prime-exon-id.value[x]:valueCodeableConcept",
      "path" : "Observation.component.value[x]",
      "sliceName" : "valueCodeableConcept",
      "min" : 0,
      "max" : "1",
    ...
    {
      "id" : "Observation.component:five-prime-strand",
      "path" : "Observation.component",
      "sliceName" : "five-prime-strand",
      "short" : "5' Strand",
      "_short" : {
        "extension" : [{
          "extension" : [{
    ...
    {
      "id" : "Observation.component:five-prime-strand.code",
      "path" : "Observation.component.code",
      "patternCodeableConcept" : {
        "coding" : [{
          "system" : "https://www.medizininformatik-initiative.de/fhir/ext/modul-mtb/CodeSystem/mii-cs-mtb-molekulare-biomarker",
    ...
    {
      "id" : "Observation.component:five-prime-strand.value[x]",
      "path" : "Observation.component.value[x]",
      "slicing" : {
        "discriminator" : [{
          "type" : "type",
    ...
    {
      "id" : "Observation.component:five-prime-strand.value[x]:valueCodeableConcept",
      "path" : "Observation.component.value[x]",
      "sliceName" : "valueCodeableConcept",
      "min" : 0,
      "max" : "1",
    ...
    {
      "id" : "Observation.component:three-prime-transcript-id",
      "path" : "Observation.component",
      "sliceName" : "three-prime-transcript-id",
      "short" : "3' Transcript - Identifier",
      "_short" : {
        "extension" : [{
          "extension" : [{
            "url" : "lang",
          ...
          {
            "url" : "content",
            "valueString" : "3' Transkript - Identifier"
          }],
          "url" : "http://hl7.org/fhir/StructureDefinition/translation"
        },
        {
          ...
          {
            "url" : "content",
            "valueString" : "3' Transcript - Identifier"
          }],
          "url" : "http://hl7.org/fhir/StructureDefinition/translation"
        }]
      },
    ...
    {
      "id" : "Observation.component:three-prime-transcript-id.code",
      "path" : "Observation.component.code",
      "patternCodeableConcept" : {
        "coding" : [{
          "system" : "https://www.medizininformatik-initiative.de/fhir/ext/modul-mtb/CodeSystem/mii-cs-mtb-molekulare-biomarker",
    ...
    {
      "id" : "Observation.component:three-prime-transcript-id.value[x]",
      "path" : "Observation.component.value[x]",
      "slicing" : {
        "discriminator" : [{
          "type" : "type",
    ...
    {
      "id" : "Observation.component:three-prime-transcript-id.value[x]:valueCodeableConcept",
      "path" : "Observation.component.value[x]",
      "sliceName" : "valueCodeableConcept",
      "min" : 0,
      "max" : "1",
    ...
    {
      "id" : "Observation.component:three-prime-exon-id",
      "path" : "Observation.component",
      "sliceName" : "three-prime-exon-id",
      "short" : "3' Exon - Identifier",
      "_short" : {
        "extension" : [{
          "extension" : [{
            "url" : "lang",
    ...
    {
      "id" : "Observation.component:three-prime-exon-id.code",
      "path" : "Observation.component.code",
      "patternCodeableConcept" : {
        "coding" : [{
          "system" : "https://www.medizininformatik-initiative.de/fhir/ext/modul-mtb/CodeSystem/mii-cs-mtb-molekulare-biomarker",
    ...
    {
      "id" : "Observation.component:three-prime-exon-id.value[x]",
      "path" : "Observation.component.value[x]",
      "slicing" : {
        "discriminator" : [{
          "type" : "type",
    ...
    {
      "id" : "Observation.component:three-prime-exon-id.value[x]:valueCodeableConcept",
      "path" : "Observation.component.value[x]",
      "sliceName" : "valueCodeableConcept",
      "min" : 0,
      "max" : "1",
    ...
    {
      "id" : "Observation.component:three-prime-position.value[x]",
      "path" : "Observation.component.value[x]",
      "slicing" : {
        "discriminator" : [{
          "type" : "type",
    ...
    {
      "id" : "Observation.component:three-prime-position.value[x]:valueRange",
      "path" : "Observation.component.value[x]",
      "sliceName" : "valueRange",
      "min" : 0,
      "max" : "1",
    ...
    {
      "id" : "Observation.component:three-prime-strand",
      "path" : "Observation.component",
      "sliceName" : "three-prime-strand",
      "short" : "3' Strand",
      "_short" : {
        "extension" : [{
          "extension" : [{
    ...
    {
      "id" : "Observation.component:three-prime-strand.code",
      "path" : "Observation.component.code",
      "patternCodeableConcept" : {
        "coding" : [{
          "system" : "https://www.medizininformatik-initiative.de/fhir/ext/modul-mtb/CodeSystem/mii-cs-mtb-molekulare-biomarker",
    ...
    {
      "id" : "Observation.component:three-prime-strand.value[x]",
      "path" : "Observation.component.value[x]",
      "slicing" : {
        "discriminator" : [{
          "type" : "type",
    ...
    {
      "id" : "Observation.component:three-prime-strand.value[x]:valueCodeableConcept",
      "path" : "Observation.component.value[x]",
      "sliceName" : "valueCodeableConcept",
      "min" : 0,
      "max" : "1",
