...
## Example CarePlan: MTB-Beschluss Kim Musterperson
...
> **activity****reference**: [MedicationRequest: extension = 6,Preclinical data (in vitro, in vivo models or functional genomics studies) demonstrate that the biomarker predicts response to a specific drug treatment, supported by scientific rationale.,http://www.ncbi.nlm.nih.gov/pubmed#31209687; status = draft; intent = option; medication[x] = COBIMETINIB; authoredOn = 2023-03-28](MedicationRequest-mii-exa-mtb-medication-request-cobimetinib.md)
