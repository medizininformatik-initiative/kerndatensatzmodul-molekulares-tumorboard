...
## Resource Profile: MII PR MTB Histologie-Evaluation Auftrag 

| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-mtb/StructureDefinition/mii-pr-mtb-histologie-evaluation-auftrag | *Version*:2027.0.0-ballot.1 |
| Active as of 2026-09-21 | *Computable Name*:MII_PR_MTB_Histologie_Evaluation_Auftrag |
...
1. The search parameter "code" MUST be supported:Examples:`GET [base]/ServiceRequest?code=http://snomed.info/sct|183825009`Usage notes: Further information on searching by "code" can be found in the [FHIR base specification - section "Token Search"](http://hl7.org/fhir/R4/search.html#token)
...
Example: Request for histological evaluation for Kim Musterperson dated 2023-03-28 (see [Scenarios](guidance.md))
...
Other representations of profile: [CSV](../StructureDefinition-mii-pr-mtb-histologie-evaluation-auftrag.csv), [Excel](../StructureDefinition-mii-pr-mtb-histologie-evaluation-auftrag.xlsx), [Schematron](../StructureDefinition-mii-pr-mtb-histologie-evaluation-auftrag.sch) 
