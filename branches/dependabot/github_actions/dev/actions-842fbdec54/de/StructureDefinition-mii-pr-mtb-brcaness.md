# MII PR MTB BRCAness - MII IG Kerndatensatz-Modul Molekulares Tumorboard v2027.0.0-ballot.1

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII PR MTB BRCAness**

## Ressourcenprofil: MII PR MTB BRCAness 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-mtb/StructureDefinition/mii-pr-mtb-brcaness | *Version*:2027.0.0-ballot.1 |
| Active Stand: 2026-09-21 | *Maschinenlesbarer Name*:MII_PR_MTB_BRCAness |
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-pr-mtb-brcaness.csv), [Excel](../StructureDefinition-mii-pr-mtb-brcaness.xlsx), [Schematron](../StructureDefinition-mii-pr-mtb-brcaness.sch) 
