# MII PR MTB Consent - MII IG Kerndatensatz-Modul Molekulares Tumorboard v2027.0.0-ballot.1

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII PR MTB Consent**

## Ressourcenprofil: MII PR MTB Consent 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-mtb/StructureDefinition/mii-pr-mtb-consent-given | *Version*:2027.0.0-ballot.1 |
| Active Stand: 2026-09-15 | *Maschinenlesbarer Name*:MII_PR_MTB_Consent_Given |
...
1. Der Suchparameter "combo-value-concept" MUSS unterstützt werden:Beispiele:`GET [base]/Observation?combo-value-concept=http://loinc.org|LA33-6`Anwendungshinweise: Weitere Informationen zur Suche nach "combo-value-concept" finden sich in der [FHIR-Basisspezifikation - Abschnitt "Token Search"](https://hl7.org/fhir/R4/search.html#token).
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-pr-mtb-consent-given.csv), [Excel](../StructureDefinition-mii-pr-mtb-consent-given.xlsx), [Schematron](../StructureDefinition-mii-pr-mtb-consent-given.sch) 
