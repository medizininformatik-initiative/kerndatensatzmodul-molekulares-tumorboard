...
<!-- Migrated from the Simplifier IG (TechnischeImplementierung/DNPM-Transformation). TODO:REVIEW machine-translated. -->
...
The DNPM source data model represents the JSON structure of the [DNPM DIP MTB API](https://dnpm-dip.net/api/mtb/fake/data/patient-record) as a FHIR logical model.
Source: [DAM data model V2.1 incl. MVGenomSeq adjustments](https://ibmi-ut.atlassian.net/wiki/spaces/DAM/pages/698777783/Datenmodell+V2.1+-+inkl.+MVGenomSeq-Anpassungen)
...
2. load all FML StructureMaps into Matchbox
3. run the transformation
4. store the resulting bundle at `scripts/output/mii-mtb-bundle.json`
