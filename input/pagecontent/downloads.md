...
This page links the downloadable artifacts of the **Molecular Tumor Board** module.
...
This module publishes that page as [ImplementationGuide-mii-ig-mtb](ImplementationGuide-mii-ig-mtb.html).
