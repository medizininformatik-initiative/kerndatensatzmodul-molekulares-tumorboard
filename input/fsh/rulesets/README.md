...
| `thomas.debertshaeuser@charite.de` | `crmi.fsh` (`artifact-author`) |
| `2026-03-30` | passed in at the call site: `insert CRMIApprovalDate(2026-03-30)` |
| `C3262` | passed in at the call site: `insert CRMIArtifactTopic(…, C3262)` |
