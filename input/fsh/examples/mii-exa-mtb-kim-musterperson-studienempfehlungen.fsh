...
// NOTE: Siehe https://clinicaltrials.gov/study/NCT04503278
...
* phase = #phase-1
* condition = $SCT#369757002 "Solid tumor configuration"
...
* characteristic[=].valueCodeableConcept = $SCT#41847000 "Adulthood (qualifier value)"
* characteristic[=].exclude = false
* characteristic[+].code.text = "Age Group (Older Adult)"
* characteristic[=].valueCodeableConcept = $SCT#271872005 "Old age (qualifier value)"
* characteristic[=].exclude = false
...
Usage: #example
* status = #active
* useContext.code = $SCT#362956003 "Procedure/intervention (navigational concept)"
* useContext.valueCodeableConcept.coding = $SCT#12893009 "Biological"
...
Usage: #example
* code = $SCT#768734005 "Study coordinator"
