// TEMPORARILY COMMENTED OUT: This technical test bundle causes many validation errors
// due to embedded resource copies with display mismatches. Will be re-enabled after
// all WRONG_DISPLAY errors are fixed in the source examples.
//
...
// * entry[=].resource.medicationCodeableConcept.coding[+] = $ATC_DE#L01FX26 "Mirvetuximab soravtansin"
// * entry[=].resource.medicationCodeableConcept.coding[=].version = "2025"
