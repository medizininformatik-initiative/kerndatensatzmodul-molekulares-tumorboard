...
* interpretation.coding = $LNC#LA6576-8 "Her2low"
...
* component[=].valueCodeableConcept[=].coding = $UNIPROT#P09758  "Tumor-associated calcium signal transducer 2" //extra LOINC Part!
