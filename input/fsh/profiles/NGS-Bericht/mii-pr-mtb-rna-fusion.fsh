...
* insert Translation(component[effect] ^short, de-DE, RNA-Fusionseffekt)
* insert Translation(component[effect] ^short, en, RNA Fusion Effect)
...
* insert Translation(component[cosmic-id] ^short, de-DE, RNA-Fusion Cosmic-ID)
* insert Translation(component[cosmic-id] ^short, en, RNA Fusion Cosmic-ID)
