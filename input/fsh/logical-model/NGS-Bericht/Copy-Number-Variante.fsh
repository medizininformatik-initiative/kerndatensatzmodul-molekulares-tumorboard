...
* CopyNumberVariant                 ->      "MII_PR_MolGen_Variante"
  ...
  * CNB                             ->      "MII_PR_MolGen_Variante.component[cnb]"
  * ReportedAffectedGenes           ->      "MII_PR_MolGen_Variante.component[gene-studied]"
  * ReportedFocality                ->      "MII_PR_MolGen_Variante.component[reported-focality]"
  * Type                            ->      "MII_PR_MolGen_Variante.component[cnv-type]"
  * CopyNumberNeutralLoH            ->      "MII_PR_MolGen_Variante.component[copy-number-neutral-loh]"