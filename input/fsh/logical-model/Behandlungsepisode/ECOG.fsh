...
* ECOG                             0..*      BackboneElement     "ECOG Performance Status"                    "ECOG Performance Status bei Einschluss ins Molekulare Tumorboard"
  ...
  * AllgemeinerLeistungszustand    0..1      code                "Verweis auf Allgemeiner Leistungszustand"   "Verweis auf die Bewertung des allgemeinen Leistungszustandes"

RuleSet: ECOGMapping
* ECOG                          -> "Observation"
  * Datum                       -> "Observation.effectiveDateTime"
