<!-- Migriert aus dem Simplifier-IG (Quelle(n): MIIIGModulMTB/TechnischeImplementierung/FHIRProfile/Behandlungsepisode/Therapieplan-MTB-Beschluss/Weitere-Empfehlungen/Histologie-Evaluation-Auftrag-ServiceRequest.page.md). TODO:REVIEW -->
---
...
Beispiel: Auftrag zur histologischen Evaluation für Kim Musterperson vom 28.03.2023 (siehe [Szenarien](guidance.html))
